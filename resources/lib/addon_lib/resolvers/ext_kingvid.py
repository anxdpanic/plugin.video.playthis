...
class ExternalKingvidResolver(UrlResolver):
    name = "kingvid"
    domains = ["kingvid.tv"]
    ...
    @classmethod
    def _is_enabled(cls):
        return common.get_setting('KingvidResolver_enabled') == 'true'

    @classmethod
    def _get_priority(cls):
        try:
            return int(common.get_setting('KingvidResolver_priority')) - 1
        except:
            return 99
