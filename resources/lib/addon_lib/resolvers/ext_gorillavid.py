...
class ExternalGorillavidResolver(UrlResolver):
    name = "gorillavid"
    ...
    @classmethod
    def _is_enabled(cls):
        return common.get_setting('GorillavidResolver_enabled') == 'true'

    @classmethod
    def _get_priority(cls):
        try:
            return int(common.get_setting('GorillavidResolver_priority')) - 1
        except:
            return 99
