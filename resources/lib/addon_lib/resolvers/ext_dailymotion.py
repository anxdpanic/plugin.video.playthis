...
class ExternalDailymotionResolver(UrlResolver):
    name = 'dailymotion'
    ...
    @classmethod
    def _is_enabled(cls):
        return common.get_setting('DailymotionResolver_enabled') == 'true'

    @classmethod
    def _get_priority(cls):
        try:
            return int(common.get_setting('DailymotionResolver_priority')) - 1
        except:
            return 99
