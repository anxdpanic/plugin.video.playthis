"""
    ...
    Copyright (c) 2007-2013 Einar Lielmanis, Liam Newman, and contributors (JS Beautifier)
    Copyright (C) 2013-2016 Bstrdsmkr, t0mm0, tknorris (urlresolver XBMC Addon)
    Copyright (C) 2016-2019 anxdpanic

    This file is part of PlayThis (plugin.video.playthis)

    SPDX-License-Identifier: MIT
    See LICENSES/MIT for more information.
    
    Adapted for use in Kodi from:
